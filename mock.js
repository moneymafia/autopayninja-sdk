...
async function test() {
  ...
  var a = await sdk.subscriptions(
    "0x3641f0010d27fda41cf04df7f792a19dc7f7976f7ee36feda87e6ced5a8e384b"
  );
  console.log("SUBSCRIPTION", a);

  var a = await sdk.canUserPay(
    "0x3641f0010d27fda41cf04df7f792a19dc7f7976f7ee36feda87e6ced5a8e384b",
    4
  );
  console.log("canUserPay", a);

  var a = await sdk.getUserTokenData(
...
async function test2() {
  ...
  var a = await sdk.graphSubscriptions(
    `where: {merchant: "0x000000000000000000000000000000000000dead"}`
  );
  console.log(a);

  var a = await sdk.graphTransfers(
    `where: {from: "0x23ed8bbed4fd61d25189ca921448fe15f1b04301"}`
  );
  console.log(a);

  // get all payments for a particular sub hash
  var a = await sdk.graphTransfers(
    `where: {hash: "0x9e5d86e9faebad2d133d390fd613f924f0a80d821a75137881c598a119f54bb2"}`
  );
  console.log(a);
}
...
async function test3() {
  ...
  var a = await getSubscriptionLink(
